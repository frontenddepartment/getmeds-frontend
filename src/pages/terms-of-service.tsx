...
export default function TermsOfService() {
  ...
  useEffect(() => {
    document.title = 'Terms of Service — Getmeds';
    ...
    canonicalEl.setAttribute('href', 'https://getmeds.ph/terms-of-service');
    ...
    getPolicyBySlug('terms-of-service')
      .then((data) => {
        if (data?.contentHtml) {
      ...
      .catch((err) => {
        console.warn('Failed to fetch Terms of Service from Sanity database:', err);
      });
  }, []);
        ...
        <article className="min-w-0">
          {dynamicHtml ? (
            ...
            <div className="p-6 bg-white rounded-xl shadow-sm border border-gray-100">
              <h2 className="text-xl font-bold mb-3 text-gray-900">Terms of Service</h2>
              <p className="text-gray-700 text-sm leading-relaxed mb-4">
                Welcome to Getmeds. By accessing or using our platform, services, or website, you agree to be bound by these Terms of Service.
              </p>
            </div>
          )}
        </article>
