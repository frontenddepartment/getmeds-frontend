...
export default function PrivacyPolicy() {
  ...
  useEffect(() => {
    document.title = 'Privacy Policy — Getmeds';
    ...
    canonicalEl.setAttribute('href', 'https://getmeds.ph/privacy-policy');
    ...
    getPolicyBySlug('privacy-policy')
      .then((data) => {
        if (data?.contentHtml) {
      ...
      .catch((err) => {
        console.warn('Failed to fetch Privacy Policy from Sanity database:', err);
      });
  }, []);
          ...
          {dynamicHtml ? (
            ...
            <div className="p-6 bg-white rounded-xl shadow-sm border border-gray-100">
              ...
              <p className="text-gray-700 text-sm leading-relaxed mb-4">
                Getmeds Philippines is committed to protecting your personal data in accordance with Republic Act No. 10173 (Data Privacy Act of 2012).
              </p>
            </div>
          )}
        </article>
